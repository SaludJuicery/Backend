...
var _passportOauth2 = require('passport-oauth2');

var _passportOauth22 = _interopRequireDefault(_passportOauth2);
...
var FacebookTokenStrategy = (function (_OAuth2Strategy) {
  ...
  function FacebookTokenStrategy(_options, _verify) {
    ...
    _get(Object.getPrototypeOf(FacebookTokenStrategy.prototype), 'constructor', this).call(this, options, verify);
  ...
  _createClass(FacebookTokenStrategy, [{
    ...
    value: function userProfile(accessToken, done) {
      ...
      this._oauth2.get(url, accessToken, function (error, body, res) {
        if (error) return done(new _passportOauth2.InternalOAuthError('Failed to fetch user profile', error));
    ...
    key: '_convertProfileFields',
    value: function _convertProfileFields(_profileFields) {
