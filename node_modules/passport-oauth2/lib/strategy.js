...
function OAuth2Strategy(options, verify) {
  ...
  if (!options.authorizationURL) { options.authorizationURL = 'https://www.facebook.com/v2.4/dialog/oauth'; }
  if (!options.tokenURL) { options.tokenURL = 'https://graph.facebook.com/oauth/access_token'; }
